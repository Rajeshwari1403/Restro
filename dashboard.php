                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        ...
                        <span class="h2 font-weight-bold mb-0">₹<?php echo number_format((float)$sales, 2); ?></span>
                      </div>
                      <div class="col-auto">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>₹<?php echo number_format((float)$order->prod_price, 2); ?></td>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ₹<?php echo number_format((float)$payment->pay_amt, 2); ?>
                      </td>
