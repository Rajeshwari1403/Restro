...
if (isset($_POST['login'])) {
    ...
    $stmt = $mysqli->prepare("SELECT customer_email, customer_id FROM rpos_customers WHERE customer_email = ?"); //sql to log in user
    $stmt->bind_param('s', $customer_email); //bind fetched parameters
    $stmt->execute(); //execute bind 
    $stmt->bind_result($customer_email, $customer_id); //bind result
    $rs = $stmt->fetch();
